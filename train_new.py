...
def main():
    ...
    def train(train_loader):
        ...
        Sgtl = student.s_gtl.cuda()
        Smll = student.s_mll.cuda()
        Sbbl = student.s_bbl.cuda()
        Sbsl = student.s_bsl.cuda()

        Tgtl = teacher.t_gtl.cuda()
        Tmll = teacher.t_mll.cuda()
        Tbbl = teacher.t_bbl.cuda()
        Tbsl = teacher.t_bsl.cuda()
